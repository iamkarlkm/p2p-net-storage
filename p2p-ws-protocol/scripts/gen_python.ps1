...
& protoc "--proto_path=$protoDir" "--python_out=$outDir" (Join-Path $protoDir "p2p_wrapper.proto") (Join-Path $protoDir "p2p_control.proto") (Join-Path $protoDir "novel_writer.proto")
