...
public class CleanDir {
    public static void main2(String[] args) {
        String to = args[0];
        String from = args[1];
        scanDir( new File(from));
    }
    
    public static void main(String[] args) {
         scanDir( new File("D:\\Administrator\\Downloads\\java-p2p-websocket-complete-v2\\java-p2p-websocket2"));
    }
    
    private static boolean cleanAction(File file){
    ...
    public static void scanDir(File from){
