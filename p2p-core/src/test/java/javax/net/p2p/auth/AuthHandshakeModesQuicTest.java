...
public class AuthHandshakeModesQuicTest {
    ...
    private void testOneMode(String cryptoMode) throws Exception {
        ...
        File yamlFile = null;
        File keyDir = null;
        P2PServerQuic server = null;
        P2PClientQuic client = null;
        try {
            ...
            keyDir = new File("target/auth-keys-quic-" + cryptoMode + "-" + port);
            keyDir.mkdirs();
            ...
            String yaml = ""
                ...
                + "keyDir: \"auth-keys-quic-" + cryptoMode + "-" + port + "\"\n"
                + "client:\n"
                + "  userId: \"" + userId + "\"\n"
            ...
            yamlFile = new File("target/auth-test-quic-" + cryptoMode + "-" + port + ".yaml");
