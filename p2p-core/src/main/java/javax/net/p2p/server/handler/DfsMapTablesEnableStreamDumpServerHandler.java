...
public class DfsMapTablesEnableStreamDumpServerHandler implements P2PCommandHandler {
    @Override
    public P2PCommand getCommand() {
        return P2PCommand.DFS_MAP_INT_TABLES_ENABLE_STREAM_DUMP;
    }
    ...
    public P2PWrapper process(P2PWrapper request) {
        ...
        if (!(request.getData() instanceof DfsMapTablesEnableReq req)) {
            return P2PErrors.stdError(request.getSeq(), P2PErrorCode.INVALID_REQUEST, "invalid DFS_MAP_INT_TABLES_ENABLE_STREAM_DUMP payload");
        }
