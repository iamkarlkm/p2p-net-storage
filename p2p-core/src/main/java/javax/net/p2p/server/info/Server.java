...
public class Server {
    ...
    public void nowStatus() throws Exception {
    ...
    private void setSysInfo() {
		...
		try {
			sys.setComputerName( Inet4Address.getLocalHost().getHostName());
			sys.setComputerIp( Inet4Address.getLocalHost().getHostAddress());
