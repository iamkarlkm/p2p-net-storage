 ...
 */
class NioDatagramChannelConfigExt extends DefaultDatagramChannelConfig {
    ...
    NioDatagramChannelConfigExt(NioDatagramChannelExt channel, DatagramChannel javaChannel) {
