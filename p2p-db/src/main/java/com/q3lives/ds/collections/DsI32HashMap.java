 ...
 * </ul>
 */
public class DsI32HashMap extends DsObject  implements Map<Integer,Integer>{
    ...
    private DsI32HashMap nextHashMap;
    ...
    public DsI32HashMap(File file) {
        ...
        File file64m = new File(file.getAbsolutePath()+".m64");//8字节索引 8位哈希 => 256*2bit(位图)/8 + 256*4byte(key) + 256*8byte(value) = 64+512+2048 =3136
        DsI32HashMap dsHashMap64 = new DsI32HashMap(file64m,4,4,3136,8,keyStore64);
        
        File file32m = new File(file.getAbsolutePath()+".m32");//4字节索引 8位哈希 => 256*2bit(位图)/8 + 256*4byte(key) + 256*4byte(value) = 64+512+2048 =2112
        File file32 = new File(file.getAbsolutePath()+".k32");
        DsObject keyStore32 = new DsObject(file32,8);//2^31个key(8字节64位)索引
        nextHashMap = new DsI32HashMap(file32m,2,2112,4,keyStore32,dsHashMap64);
    }
     ...
     * @param keyStore
     */
    public DsI32HashMap(File file,int hashOffset,int dataSize,DsObject keyStore) {
        super(file, dataSize);
        zeroNode = new long[this.dataUnitSize / 8];
        initHeader();
     ...
     * @param keyStore
     */
    public DsI32HashMap(File file,int hashOffset,int hashLen,int dataSize,int keyStoreLen,DsObject keyStore) {
        super(file, dataSize);
        zeroNode = new long[this.dataUnitSize / 8];
        initHeader();
        this.hashOffset = hashOffset;
     ...
     * @param nextHashMap
     */
    public DsI32HashMap(File file,int hashOffset,int dataSize,int keyStoreLen,DsObject keyStore32,DsI32HashMap nextHashMap) {
        super(file, dataSize);
        zeroNode = new long[this.dataUnitSize / 8];
        initHeader();
        this.hashOffset = hashOffset;
    ...
    public Set<Integer> keySet() {
        return new AbstractSet<Integer>() {
            ...
            @Override
            public int size() {
                return DsI32HashMap.this.size();
            }

            @Override
            public boolean contains(Object o) {
                return DsI32HashMap.this.containsKey(o);
            }

            @Override
            public boolean remove(Object o) {
                return DsI32HashMap.this.remove(o) != null;
            }

            @Override
            public void clear() {
                DsI32HashMap.this.clear();
            }
        };
    }
            ...
            public Iterator<Entry<Integer, Integer>> iterator() {
                ...
                return new Iterator<Entry<Integer, Integer>>() {
                    ...
                    public Entry<Integer, Integer> next() {
                        ...
                        return new Entry<Integer, Integer>() {
                            ...
                            public Integer getValue() {
                                return DsI32HashMap.this.get(entryKey);
                            }

                            @Override
                            public Integer setValue(Integer value) {
                                return DsI32HashMap.this.put(entryKey, value);
                            }
                    ...
                    public void remove() {
                        ...
                        DsI32HashMap.this.remove(lastKey);
                        canRemove = false;
                    }
                };
            }
