...
public class DsDirectoryStore {
     ...
     */
    public DsDirectoryStore(String rootDir) {
    ...
    public long createDir() throws IOException {
        ...
        long id = store.put(DsFixedBucketStore.INDEPENDENT_SPACE, "dir4k", zeros);
        initInode(id);
        return id;
    }
    ...
    public long allocateFileId() throws IOException {
        ...
        return store.put(DsFixedBucketStore.INDEPENDENT_SPACE, "fid", zeros);
    }
    ...
    private long allocate64kBlock() throws IOException {
        ...
        long id = store.put(DsFixedBucketStore.INDEPENDENT_SPACE, "dir64k", zeros);
        init64kBlock(id);
        return id;
    }
    ...
    private long allocate64mBlock() throws IOException {
        ...
        long id = store.put(DsFixedBucketStore.INDEPENDENT_SPACE, "dir64m", zeros);
        init64mBlock(id);
        return id;
    }
    ...
    private byte[] readBlock(String type, long id, int size) throws IOException {
        return store.get(DsFixedBucketStore.INDEPENDENT_SPACE, type, id, 0, size);
    }
