 ...
 * @info 类似于MyHashMap64的Set容器
 *
 * @Advantage 按照元素的hashCode或hashCode64自然排序的 HashSet容器（64位哈希键）
 */
public class MyHashSet64<K> implements Set, Serializable {

    private static final long serialVersionUID = 20100721L;
    private int size;
    private transient List<K> resultKey;

    private MySetUnit64<K> set = new MySetUnit64<K>();
    ...
    public boolean retainAll(Collection c) {
        //clear();
        MySetUnit64<K> set2 = new MySetUnit64<K>();
        Iterator<K> it = c.iterator();
        int count = 0;
        while (it.hasNext()) {
            Object obj = it.next();
    ...
    public static void main(String[] args) {
        MyHashSet64<Integer> set = new MyHashSet64<Integer>();
        //测试一下自然排序
        set.add(8);
        set.add(2000);
        set.add(1);
...
//		hashcode64 |= (tmp1<<32);
//		//if(key.equals(8)){
//			System.out.println("h:"+hashcode64);
//		//}
//		hashcode64 |= 1 & 0x00000000ffffffffL;
//		//if(key.equals(8)){
//			System.out.println("l:"+hashcode64);
//		//}
    }
}
