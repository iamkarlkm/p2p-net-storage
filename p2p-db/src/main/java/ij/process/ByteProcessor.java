...
import ij.gui.*;
import ij.Prefs;
import static ij.process.ImageProcessor.BICUBIC;
import static ij.process.ImageProcessor.BILINEAR;
import static ij.process.ImageProcessor.BLUR_MORE;
import static ij.process.ImageProcessor.FIND_EDGES;
import static ij.process.ImageProcessor.MAX;
import static ij.process.ImageProcessor.MEDIAN_FILTER;
import static ij.process.ImageProcessor.MIN;
import static ij.process.ImageProcessor.NONE;
import static ij.process.ImageProcessor.NO_THRESHOLD;
import static ij.process.ImageProcessor.WRONG_LENGTH;
import static ij.process.ImageProcessor.rnd;
import static ij.process.ImageProcessor.seed;
