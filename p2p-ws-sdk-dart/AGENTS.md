...
Use this file as a Brain-managed project context entrypoint for `p2p-ws-sdk-dart`.
...
5. Retrieve project memory with `brain find p2p-ws-sdk-dart` or `brain search "p2p-ws-sdk-dart <task>"` when the compiled packet is not enough.
