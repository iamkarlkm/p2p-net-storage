    ...
    public static P2PClient getInstance() throws UnknownHostException{
        if(CLIENT==null){
            synchronized(P2PClient.class){
                if(CLIENT==null){
                    CLIENT = new P2PClient(InetAddress.getByName(P2PServer.SERVER_IP),P2PServer.SERVER_PORT);
	 ...
	 public static P2PClient getInstance(String serverIp) throws UnknownHostException{
        ...
        return new P2PClient(InetAddress.getByName(serverIp),P2PServer.SERVER_PORT);
    }
...
//        channelPool.release(channel);
        ...
        Future<P2PWrapper> futureTask = ExecutorServicePool.CLIENT_ASYNC_POOLS.submit(task);
        return futureTask;
