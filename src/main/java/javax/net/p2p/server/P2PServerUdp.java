...
public class P2PServerUdp extends AbstractP2PServer {
    ...
    public static String SERVER_IP = "127.0.0.1";//hdfs image server
    ...
    public static void main(String[] args) throws Exception {
        ...
        P2PServerUdp server = P2PServerUdp.getInstance(P2PServerUdp.class);
            ...
            server.group(acceptBossGroup)
                    ...
                    .handler(new ChannelInitializer<NioDatagramChannel>() {
                        ...
                        protected void initChannel(NioDatagramChannel ch)
                            ...
                            PipelineInitializer.initProcessorsUdp(ch, new ServerUdpMessageProcessor((P2PServerUdp) inatance, magic, queueSize), magic);
                        }
                    });
            PipelineInitializer.initOptionsUdp(server);
            // 绑定端口，开始接收进来的连接
//           InetSocketAddress address = new InetSocketAddress(InetAddress.getLocalHost(), port);
            ChannelFuture future = server.bind(6060).sync();
...
//           让线程进入wait状态，也就是main线程暂时不会执行到finally里面，nettyserver也持续运行，如果监听到关闭事件，可以优雅的关闭通道和nettyserver
    ...
    public void singletonFinalized() {
        if (acceptBossGroup != null) {
            ...
            ExecutorServicePool.releaseServerPools();
//            try {
