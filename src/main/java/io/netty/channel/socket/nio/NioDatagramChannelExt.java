 ...
 * @see DatagramPacket
 */
public final class NioDatagramChannelExt
     ...
     */
    public NioDatagramChannelExt(SelectorProvider provider) {
     ...
     */
    public NioDatagramChannelExt(InternetProtocolFamily ipFamily) {
     ...
     */
    public NioDatagramChannelExt(SelectorProvider provider, InternetProtocolFamily ipFamily) {
     ...
     */
    public NioDatagramChannelExt(DatagramChannel socket) {
        super(null, socket, SelectionKey.OP_READ);
        config = new NioDatagramChannelConfigExt(this, socket);
    }
...
//             long localFlushedAmount = region.transferTo(javaChannel(), position);
